class AutoresAdmModel {
  final int id;
  final String nome;

  const AutoresAdmModel({required this.id, required this.nome});

  factory AutoresAdmModel.fromJson(Map<String, dynamic> json) {
    if (json.containsKey('autor_id') && json.containsKey('nome')) {
      return AutoresAdmModel(
        id: json['autor_id'],
        nome: json['nome'],
      );
    } else {
