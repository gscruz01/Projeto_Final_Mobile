...
class PostLivros_adm extends StatefulWidget {
  const PostLivros_adm({super.key});

  @override
  State<PostLivros_adm> createState() => _PostLivros_admState();
}

class _PostLivros_admState extends State<PostLivros_adm> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pop(
                context); // Retorna à tela anterior sem recriar a lista
          },
        ),
        iconTheme:
