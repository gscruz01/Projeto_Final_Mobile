...
import 'package:ola_mundo/features/editoras/presentation/dummies/post_Editoras.dart';
...
class EditorasPage extends StatefulWidget {
  ...
  @override
  State<EditorasPage> createState() => _EditorasState();
}

class _EditorasState extends State<EditorasPage> {
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            final result = await Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const PostEditoras()),
                            );
                            if (result == true) {
                              setState(() {
                                listaEditoras = useCaseEditoras.getEditoras();
